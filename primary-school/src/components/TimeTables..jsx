export default function Timetables() {
  return (
    <section className="max-w-5xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-center text-blue-800">School Timetables</h1>

      {/* Grade 1–7 Class Timetables */}
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Grade 1–7 Class Timetables</h2>
      ...
      {/* Exam Timetable */}
      <div className="mb-10">
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Exam Timetable</h2>
        <p className="mb-2 text-gray-700">Download the latest exam schedule below:</p>
        <a
          href="/files/exam-timetable.pdf"
      ...
      <div>
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Extra-Mural Timetable</h2>
        <p className="mb-2 text-gray-700">Explore the timetable for sports, clubs, and afternoon programs:</p>
        <a
          href="/files/extramural-timetable.pdf"
